...
// 1.00 Test
        ...
        request.Set(GatewayRequest.USERNAME, "dotnettest_user");
        request.Set(GatewayRequest.CUSTOMER_PASSWORD, "dotnettest_pass");
...
//
        ...
        request.Set(GatewayRequest.EMAIL, "dotnettest_updated@fakedomain.com");
        request.Set(GatewayRequest.USERNAME, "dotnettest_user_updated");
        request.Set(GatewayRequest.CUSTOMER_PASSWORD, "dotnettest_pass_updated");
